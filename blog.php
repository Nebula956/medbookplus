...
//fetch all posts from diseasepost table
$query="SELECT * FROM diseaseposts  ORDER by date_time  DESC  ";
$posts=mysqli_query($connection,$query);
?>
    <section class="search_bar">
        <form class="container search_bar-container"action="<?=ROOT_URL?>search1.php" method="GET">
            <div>
...
<div class="container category_buttons-container">
  <?php
  $all_categories_query="SELECT * from diseasecategories";
