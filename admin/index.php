...
$query="SELECT id,title,category_id FROM diseaseposts  WHERE author_id=$current_user_id ORDER BY id DESC";
            ...
            <table>
                ...
                <tbody>
                    <?php while($post=mysqli_fetch_assoc($posts)): ?>
                        ...
                        $category_query="SELECT  title from diseasecategories WHERE id=$category_id";
